...
Digite a senha que deseja usar para o login.
...
**ADMIN_PASSWORD_HASH**
```
(cole o hash gerado pelo script generate-password-hash)
```
...
Após o deploy, acesse sua aplicação e tente fazer login com as credenciais configuradas.
...
### Login não funciona
- Verifique se ADMIN_USERNAME e ADMIN_PASSWORD_HASH estão configurados
- Gere um novo hash e atualize na Vercel
